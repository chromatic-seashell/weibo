...
class GDWQRCodeViewController: UIViewController {
    ...
    // MARK: - 扫描图片二维码
    @IBAction func pictureQRCodeClick(sender: UIBarButtonItem) {
        //1.判断相册能否打开
...
// MARK: -
extension GDWQRCodeViewController: AVCaptureMetadataOutputObjectsDelegate
{

    // MARK:AVCaptureMetadataOutputObjectsDelegate方法
...
// MARK: -
extension GDWQRCodeViewController: UITabBarDelegate
{
...
// MARK: - 
extension GDWQRCodeViewController : UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    /// 只要选中一张图片, 就会调用这个代理方法
