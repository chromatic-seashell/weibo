...
*/
//class GDWStatusViewModel: NSObject
class GDWStatusViewModel{
    /// 模型对象
    var status: GDWStatus
    
    init(status: GDWStatus)
    {
        self.status = status
